const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=4920327&appid=58f3ede8a932ca945faf8e7bf4d71898&units=imperial';
fetch(apiURL)
  ...
  const apiURL2 = 'https://api.openweathermap.org/data/2.5/forecast?id=4920327&appid=58f3ede8a932ca945faf8e7bf4d71898&units=imperial';
  fetch(apiURL2)
  .then((response) => response.json())
  .then((forecastObject) => {
